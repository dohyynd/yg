...
ChangelogsGroup:AddLabel('<font color="rgb(0,255,0)"> NOL HAX</font>')
...
MovementGroup:AddSlider('WalkspeedAmount', {
    ...
    local function updateWatermark()
        ...
        game:GetService('RunService').RenderStepped:Connect(function()
            ...
            Library:SetWatermark(string.format('Ealpha X | %d FPS | By 誓约 | %d ping', math.floor(fps), math.floor(game:GetService('Stats').Network.ServerStatsItem['Data Ping']:GetValue())))
        end)
    end
