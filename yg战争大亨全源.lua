...
WindUI:Popup({
    Title = '<font color="' .. gradientColors[1] .. '">Y</font><font color="' .. gradientColors[5] .. '">G</font>',
    IconThemed = true,
    Content = "尊敬的用户 " .. coloredUsername .. " \n您使用的 <font color='" .. gradientColors[1] .. "'>G</font><font color='" .. gradientColors[5] .. "'>爱</font> 当前版本型号是: " .. coloredVersion .. "\n加入qq：1015718032",
    Buttons = {
        {
            Title = "取消",
